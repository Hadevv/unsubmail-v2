...
mod tests {
    ...
    fn test_heuristic_score() {
        ...
        assert!(score > 1.0, "Newsletter with unsubscribe should score > 1.0, got {}", score);
        ...
        assert_eq!(score, 0.5, "Personal email without unsubscribe should be capped at 0.5");
        ...
        assert!(score >= 0.8, "Marketing email with unsubscribe should score >= 0.8, got {}", score);
    }
}
